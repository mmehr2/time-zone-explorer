...
//  StampCollection
//
//  Created by Michael L Mehr on 11/3/15.
...
// support for all XCode colors from here: http://stackoverflow.com/questions/13481740/setup-ocean-color-or-other-colors
extension UIColor {
